    ...
    >
     ...
     {showAddModal && (
      ...
      <div className="py-8 max-w-7xl mx-auto px-4 space-y-8">
        {/* Wallet Balance Card */}
        <div className="bg-gradient-to-r from-accent to-accent/80 shadow-lg rounded-lg p-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
          ...
          {auth.user.role !== 'dealer' && (
            <button
              ...
              className="bg-white text-accent px-4 py-2 rounded hover:bg-gray-100 w-full sm:w-auto font-semibold"
            >
              Top Up Wallet
            </button>
          )}
                      ...
                      <td className="p-3 border">
                        {tx.status === 'pending' && (
                          <button
                            ...
                            className="bg-blue-600 hover:bg-blue-700 disabled:bg-gray-400 text-white px-3 py-1 rounded text-xs font-semibold"
                          >
