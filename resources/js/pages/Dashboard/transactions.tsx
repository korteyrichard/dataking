        ...
        <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <div className="grid grid-cols-2 gap-4 md:gap-6">
              <div className="bg-gradient-to-r from-accent to-accent/80 rounded-lg shadow-lg p-6">
                <p className="text-white/80 text-sm">Today's Top Ups</p>
                <p className="text-2xl font-bold text-white">GHS {todayTopUps}</p>
              </div>
              <div className="bg-gradient-to-r from-primary to-primary/80 rounded-lg shadow-lg p-6">
