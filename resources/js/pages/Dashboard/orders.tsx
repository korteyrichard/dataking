        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-8">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="bg-gradient-to-r from-accent to-accent/80 rounded-lg shadow-lg p-4">
                <p className="text-white text-sm">Today's Sales</p>
                <p className="text-xl font-bold text-white">GHS {todaySales}</p>
              </div>
              <div className="bg-gradient-to-r from-primary to-primary/80 rounded-lg shadow-lg p-4">
                <p className="text-white/80 text-sm">Pending Orders</p>
                <p className="text-xl font-bold text-white">{pendingOrders}</p>
              </div>
              <div className="bg-gradient-to-r from-secondary/80 to-secondary rounded-lg shadow-lg p-4">
