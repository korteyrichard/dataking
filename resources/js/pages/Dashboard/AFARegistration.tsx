  ...
  return (
    ...
    >
      ...
      <div className="py-8 max-w-4xl mx-auto px-4">
        {/* Wallet Balance Card */}
        <div className="bg-gradient-to-r from-primary to-primary/80 shadow-lg rounded-lg p-6 mb-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between pt-6">
              ...
              <button
                ...
                className="bg-accent hover:bg-accent/80 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-semibold py-2 px-6 rounded-md transition duration-200"
              >
