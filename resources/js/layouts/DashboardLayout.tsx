...
export default function DashboardLayout({ user, header, children }: DashboardLayoutProps) {
    ...
    const SidebarContent = ({ isMobile = false }: { isMobile?: boolean }) => (
        <div className="flex flex-col flex-grow bg-primary pt-5 pb-4 overflow-y-auto h-full">
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="lg:pl-64 flex flex-col flex-1">
                {/* Navbar */}
                <div className="sticky top-0 z-10 flex-shrink-0 flex h-16 bg-primary shadow-sm lg:shadow-none">
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" className="relative h-8 w-8 rounded-full">
                                        <Icon name="User" className="h-6 w-6 text-foreground" />
                                    </Button>
                                </DropdownMenuTrigger>
