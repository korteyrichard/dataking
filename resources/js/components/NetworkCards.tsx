...
const NetworkCards: React.FC<NetworkCardsProps> = ({ onAddToCart, products = [] }) => {
  ...
  return (
    <div className="space-y-4">
      <h3 className="text-lg sm:text-xl font-semibold text-gray-900 mb-4 sm:mb-6">Select Network</h3>
      
      {networks.map((network) => (
        <div key={network.id} className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
          {/* Network Card Header */}
          <div 
              ...
              <div className="p-4 sm:p-6 space-y-4 sm:space-y-6">
                ...
                <div>
                  ...
                  <Button 
                    ...
                    className="mt-3 px-6 py-2 bg-foreground hover:bg-foreground/90 text-background rounded font-medium"
                  >
                ...
                <div>
                  <button 
                    ...
                    className="px-4 py-2 bg-foreground text-background rounded font-medium mb-3"
                  >
                    📦 Text Input Orders
                  </button>
...
0501234567 3"
                ...
                <div className="bg-white/20 p-3 rounded text-xs text-white">
                ...
                <Button 
                  ...
                  className="w-full py-3 bg-white hover:bg-gray-100 text-gray-800 rounded font-semibold"
                >
                  Add to Basket
                </Button>
              </div>
